 ...
 */
  ...
  #define THERMAL_PROTECTION_PERIOD 200        // Seconds
...
#define USE_WATCHDOG
  ...
  // If you have a watchdog reloadboot in an ArduinoMega2560 then the device will hang forever, as a watchdog reset will leave the watchdog on.
